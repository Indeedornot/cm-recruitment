 ...
 */
final class Version20240924193431 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE admin (id INT NOT NULL, created_by_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_880E0D76B03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
